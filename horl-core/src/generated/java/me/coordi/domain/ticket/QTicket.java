package me.coordi.domain.ticket;
...
public class QTicket extends EntityPathBase<Ticket> {
    ...
    private static final long serialVersionUID = -64860440L;
    ...
    public final me.coordi.domain.user.QUser user;
    ...
    public QTicket(Class<? extends Ticket> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new me.coordi.domain.user.QUser(forProperty("user")) : null;
    }
